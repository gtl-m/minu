...
AppId={{0C1EB565-7D51-4D23-ABEA-8685CA2B7F16}
AppName={#MyAppName}
...
LicenseFile=E:\minu\LICENSE.txt
InfoBeforeFile=E:\minu\install1.txt
InfoAfterFile=E:\minu\install2.txt
...
[Files]
Source: "E:\minu\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
