...
AppId={{89A5DCF1-DF4B-42A8-AD5E-5B0F900BB04F}
AppName={#MyAppName}
...
LicenseFile=E:\minu\minu1.5\LICENSE.txt
InfoBeforeFile=E:\minu\minu1.5\install1.txt
InfoAfterFile=E:\minu\minu1.5\install2.txt
...
[Files]
Source: "E:\minu\minu1.5\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
