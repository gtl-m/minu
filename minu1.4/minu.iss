...
AppId={{54DFA500-109D-426B-BE55-F83BAF83ABDC}
AppName={#MyAppName}
...
LicenseFile=E:\minu\minu1.4\LICENSE.txt
InfoBeforeFile=E:\minu\minu1.4\install1.txt
InfoAfterFile=E:\minu\minu1.4\install2.txt
...
[Files]
Source: "E:\minu\minu1.4\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
